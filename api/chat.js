...
- 프로젝트 2) W:RUN(위런) 러닝 팬덤 앱: 팀 프로젝트(6인), 2026.07~2026.08. 크루, 대회 정보, 피드, AI 맞춤 추천 등으로 지속 가능한 러닝 경험을 제공하는 러닝 커뮤니티 플랫폼. 담당: UX 리서치 및 인사이트 도출, 서비스 기획 및 핵심 기능 설계, 온보딩 경험 설계, UI 디자인, React·Tailwind CSS 기반 화면 구현, 발표자료 기획서 제작.
- 프로젝트 3) MU:it(뮤잇) 클래식 음악 레슨 매칭 앱: 개인 프로젝트, 2026.03~2026.05. 선생님 탐색부터 레슨 관리, 성장 관리까지 이어지는 사용자 경험을 설계. 담당: 데스크 리서치 및 경쟁 서비스 분석, 사용자 설문조사 및 인사이트 도출, UI 디자인 및 프로토타입 제작, React 기반 화면 구현, 휴리스틱 사용성 평가, 발표자료 기획서 제작.
